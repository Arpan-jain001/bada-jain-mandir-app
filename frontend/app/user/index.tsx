      ...
      >
        <View style={styles.headerContent}>
          ...
          <View style={styles.headerActions}>
            <TouchableOpacity onPress={() => router.push('/user/notifications')} style={styles.headerIconButton}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.quickActions}>
          ...
          <Animatable.View animation="fadeInRight" delay={200}>
            <TouchableOpacity
              style={styles.actionCard}
              onPress={() => router.push('/user/projects')}
            >
              <LinearGradient
        ...
        <View style={styles.quickActions}>
          ...
          <Animatable.View animation="fadeInRight" delay={300}>
            <TouchableOpacity
              style={styles.actionCard}
              onPress={() => router.push('/user/recent-work')}
            >
              <LinearGradient
        ...
        <View style={styles.quickActions}>
          <Animatable.View animation="fadeInLeft" delay={400}>
            <TouchableOpacity
              style={styles.actionCard}
              onPress={() => router.push('/user/committee')}
            >
              <LinearGradient
        ...
        <View style={styles.quickActions}>
          ...
          <Animatable.View animation="fadeInRight" delay={500}>
            <TouchableOpacity
              style={styles.actionCard}
              onPress={() => router.push('/user/live-darshan')}
            >
              <LinearGradient
